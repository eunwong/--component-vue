        ...
        >
            ...
            <template #handle="scope">
                <div class="table-btn">
                    ...
                    <a-button @click="handleEdit(scope.value)"> 编辑</a-button>
                    <a-button @click="handleAuthoriz(scope.value)">
                        <i class="iconfont icon-31shezhi"> </i> 租户授权
                    </a-button>
                    <a-button v-if="!scope.value.status" @click="handleAudit(scope.value)"> 审核 </a-button>
...
import { PTable } from 'avic-common';
import { Modal, message } from 'ant-design-vue';
import ajax from '@/api/ajax';
import emiter from '@/ts/bus';
